...
const STEPS = [
  ...
  {
    name: "اقرأ التقرير",
    text: "راجع HTTPS والمنفذ والتحديثات المعلّقة ووقت آخر خطأ ويبهوك إن وُجد. لا نحفظ التوكن.",
  },
];
...
const APP_JSON_LD = {
  ...
  url: `${SITE}${PATH}`,
  description:
    "فحص توكن وويبهوك HTTPS والتحديثات المعلّقة ووقت آخر خطأ بلا حفظ التوكن وبلا سحب نقدي.",
};
