...
const FAQ = [
  ...
  {
    q: "ماذا يعني وقت آخر خطأ ويبهوك؟",
    a: "last_error_date من تليجرام: آخر مرة فشل فيها تسليم تحديث إلى رابطك. إن وُجد وقت حديث راجع الخادم والشهادة والمنفذ. الفاحص لا يحفظ التوكن ولا يستهلك رمز الطلب.",
  },
  {
    q: "ماذا يعني نص آخر خطأ ويبهوك؟",
    a: "last_error_message من تليجرام: سبب آخر فشل تسليم إن سجّله. غالباً شهادة أو مهلة أو عنوان خاطئ. الفاحص يعرض النص ولا يحفظ التوكن ولا يستهلك رمز الطلب.",
  },
  {
    q: "هل يعمل getUpdates مع الويبهوك؟",
    a: "لا. تليجرام يمنع الجمع بينهما على نفس البوت. إن وُجد ويبهوك تفشل getUpdates حتى يُحذف الويبهوك. الفاحص يعرض الرابط ولا يحذف الويبهوك ولا يحفظ التوكن ولا يستهلك رمز الطلب.",
  },
  {
...
const STEPS = [
  ...
  {
    name: "اقرأ التقرير",
    text: "راجع HTTPS والمنفذ والتحديثات المعلّقة ووقت ونص آخر خطأ ويبهوك إن وُجدا، وتعارض الويبهوك مع getUpdates. لا نحفظ التوكن.",
  },
];
...
const REPORT_ITEMS = [
  ...
  "وقت آخر خطأ ويبهوك إن سجّله تليجرام",
  "نص آخر خطأ ويبهوك (last_error_message) إن سجّله تليجرام",
  "ملاحظة ظهور التوكن داخل رابط الويبهوك",
  "تعارض الويبهوك مع getUpdates — لا يعملان معاً على نفس البوت",
];
...
const APP_JSON_LD = {
  ...
  url: `${SITE}${PATH}`,
  description:
    "فحص توكن وويبهوك HTTPS والتحديثات المعلّقة ووقت ونص آخر خطأ وتعارض getUpdates بلا حفظ التوكن وبلا سحب نقدي.",
};
