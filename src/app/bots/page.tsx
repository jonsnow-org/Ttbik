...
const FAQ = [
  ...
  {
    q: "هل أضبط قائمة الأوامر من الموقع؟",
    a: "لا. /setcommands من BotFather فقط. الحد من تليجرام. الضبط لا يستهلك رمز الطلب.",
  },
  {
    q: "هل يراسل البوت من لم يبدأ المحادثة؟",
    a: "لا. تليجرام يمنع المراسلة قبل /start. الموقع لا يبث رسائل جماعية نيابة عنك.",
  },
  {
    q: "هل تغيير اليوزر من BotFather يستهلك رمز الطلب؟",
    a: "لا. /setusername من BotFather ولا يفتح بوتاً ثانياً ولا يستهلك الرمز.",
  },
  {
    q: "هل أغيّر اسم البوت ووصفه من النموذج؟",
    a: "لا. /setname و/setdescription و/setabouttext من BotFather. لا تستهلك رمز الطلب.",
  },
  {
    q: "هل الموقع يرفع حد حجم الملفات في البوت؟",
    a: "لا. حد الملفات من Bot API لدى تليجرام. الموقع لا يرفع هذا الحد ولا يتجاوزه.",
  },
];
