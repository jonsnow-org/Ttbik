...
const LIMITS = [
  ...
  "تغيير @username من BotFather (/setusername) يغيّر رابط t.me فقط — لا ينشئ بوتاً جديداً ولا يستهلك رمزاً ثانياً. نفس الطلب ونفس التوكن.",
...
const FAQ = [
  ...
  {
    q: "غيّرت اسم المستخدم من BotFather هل أحتاج رمزاً جديداً؟",
    a: "لا. /setusername يغيّر رابط t.me فقط. نفس البوت ونفس التوكن ونفس رمز الطلب. لا بوت ثانٍ.",
  },
];
