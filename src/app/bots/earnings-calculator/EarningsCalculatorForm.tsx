  ...
  return (
    <main className="relative mx-auto max-w-lg px-4 py-10">
      ...
      <div className="mt-4 rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-600 p-6 text-white shadow-md">
        ...
        <p className="mt-3 text-sm text-indigo-100">عشرات آلاف السنين لتغطية الهدف بنفس الوتيرة الحالية</p>
        <p className="text-2xl font-extrabold">{result.myriadsToTarget.toFixed(2)}</p>
        <p className="mt-3 text-sm text-indigo-100">مئات آلاف السنين لتغطية الهدف بنفس الوتيرة الحالية</p>
        <p className="text-2xl font-extrabold">{result.lakhsToTarget.toFixed(2)}</p>
