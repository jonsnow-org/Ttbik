...
const HOWTO_JSON_LD = {
  ...
  description:
    "أدخل المشاهدات وCPM ونسبة البيع للحصول على تقدير شهري تقريبي بلا توكن وبلا سحب نقدي.",
  inLanguage: "ar",
  step: STEPS.map((s, i) => ({
    "@type": "HowToStep",
    position: i + 1,
...
const WEBPAGE_JSON_LD = {
  ...
  inLanguage: "ar",
  description:
    "تقدير تقريبي للأرباح حسب المشاهدات وCPM. بلا توكن BotFather وليست وعداً بربح ولا سحب نقدي. لا يستهلك رمز الطلب.",
};
...
const APP_JSON_LD = {
  ...
  url: `${SITE}${PATH}`,
  description:
    "تقدير تخطيطي حسب المشاهدات وCPM. بلا توكن وبلا وعد بربح ولا سحب نقدي ولا رصيداً.",
};
    ...
    <>
      ...
      <section className="relative mx-auto max-w-lg px-4 pb-10">
        <p className="mb-4 text-xs leading-6 text-slate-500">
          الأرقام تقريبية للتخطيط وليست وعداً بربح. لا سحب نقدي من هذه الصفحة. لا توكن مطلوب.
        </p>
