...
const DESC =
  "كود تضمين مجاني لمواقيت الصلاة بعدّاد الصلاة القادمة لأكثر من 20 مدينة عربية. انسخ سطراً واحداً والصقه في موقعك أو مدونتك، بلا تسجيل.";
    ...
    <>
      ...
      <main className="mx-auto max-w-2xl px-4 py-8" dir="rtl" lang="ar">
        ...
        <p className="mb-6 text-sm leading-7 text-slate-600">
          ...
          المواقيت تلقائياً كل يوم، وتُحسب بمكتبة adhan بنفس طريقة صفحة كل مدينة عندنا.
        </p>
