...
const ARTICLE = {
  ...
  paragraphs: [
    "ما تقوله المصادر الفلكية المنشورة هذا الأسبوع: الاعتدال الخريفي لعام 2026 وقع يوم الأربعاء 23 سبتمبر. الجمعية الفلكية بجدة — كما نقلت اليوم السابع في 24 سبتمبر — حددت اللحظة عند الساعة 03:05 بتوقيت غرينتش. اليوم السابع نقل أيضاً عن المعهد القومي للبحوث الفلكية في مصر أن التوقيت المحلي في القاهرة صباح 23 سبتمبر، وأن فصل الخريف يستمر نحو 89 يوماً و20 ساعة قبل الانقلاب الشتوي المتوقع في 21 ديسمبر.",
  ...
  faq: [
    {
      ...
      a: "يوم الأربعاء 23 سبتمبر 2026. المصدر المنقول عن الجمعية الفلكية بجدة يضع اللحظة عند 03:05 بتوقيت غرينتش.",
    },
    {
