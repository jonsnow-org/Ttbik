...
export const PRAYER_CITIES: PrayerCity[] = [
  ...
  { slug: "taif", nameAr: "الطائف", countryAr: "السعودية", lat: 21.2703, lng: 40.4158, tz: "Asia/Riyadh", method: "umm_al_qura", methodLabel: "أم القرى", note: "شرق مكة على ارتفاع أعلى. الحساب فلكي على مستوى البحر؛ الارتفاع قد يؤثر على الشفق عملياً." },
  { slug: "abha", nameAr: "أبها", countryAr: "السعودية", lat: 18.2164, lng: 42.5053, tz: "Asia/Riyadh", method: "umm_al_qura", methodLabel: "أم القرى", note: "عسير. خط عرض أجنبي من الرياض فالنهار أقرب إلى الاعتدال على مدار السنة." },
  { slug: "tabuk", nameAr: "تبوك", countryAr: "السعودية", lat: 28.3838, lng: 36.555, tz: "Asia/Riyadh", method: "umm_al_qura", methodLabel: "أم القرى", note: "شمال غرب المملكة. النهار الصيفي أطول من الرياض بسبب خط العرض." },
  { slug: "hail", nameAr: "حائل", countryAr: "السعودية", lat: 27.5114, lng: 41.6907, tz: "Asia/Riyadh", method: "umm_al_qura", methodLabel: "أم القرى", note: "شمال نجد. نفس طريقة أم القرى وتوقيت الرياض." },
  ...
  { slug: "aswan", nameAr: "أسوان", countryAr: "مصر", lat: 24.0889, lng: 32.8998, tz: "Africa/Cairo", method: "egyptian", methodLabel: "الهيئة المصرية", note: "جنوب مصر. النهار أقرب إلى الاعتدال من القاهرة." },
  { slug: "luxor", nameAr: "الأقصر", countryAr: "مصر", lat: 25.6872, lng: 32.6396, tz: "Africa/Cairo", method: "egyptian", methodLabel: "الهيئة المصرية", note: "الصعيد. نفس طريقة الهيئة المصرية وتوقيت القاهرة." },
  ...
  { slug: "sharjah", nameAr: "الشارقة", countryAr: "الإمارات", lat: 25.3463, lng: 55.4209, tz: "Asia/Dubai", method: "umm_al_qura", methodLabel: "أم القرى (شائع محلياً)", note: "شمال شرق دبي. الأوقات قريبة من دبي مع فرق دقائق." },
  { slug: "ajman", nameAr: "عجمان", countryAr: "الإمارات", lat: 25.4052, lng: 55.5136, tz: "Asia/Dubai", method: "umm_al_qura", methodLabel: "أم القرى (شائع محلياً)", note: "ملاصقة للشارقة. نفس الطريقة والتوقيت." },
  ...
  { slug: "irbid", nameAr: "إربد", countryAr: "الأردن", lat: 32.5556, lng: 35.85, tz: "Asia/Amman", method: "egyptian", methodLabel: "الهيئة المصرية", note: "شمال عمّان. نفس الطريقة والتوقيت." },
  { slug: "zarqa", nameAr: "الزرقاء", countryAr: "الأردن", lat: 32.0836, lng: 36.1, tz: "Asia/Amman", method: "egyptian", methodLabel: "الهيئة المصرية", note: "شرق عمّان. الأوقات قريبة مع فرق دقائق." },
  ...
  { slug: "mosul", nameAr: "الموصل", countryAr: "العراق", lat: 36.3489, lng: 43.157, tz: "Asia/Baghdad", method: "karachi", methodLabel: "جامعة العلوم الإسلامية كراتشي", note: "شمال العراق. النهار الصيفي أطول من بغداد." },
  ...
  { slug: "aden", nameAr: "عدن", countryAr: "اليمن", lat: 12.7855, lng: 45.0187, tz: "Asia/Aden", method: "umm_al_qura", methodLabel: "أم القرى", note: "جنوب اليمن على البحر. النهار أقرب إلى الاعتدال من صنعاء." },
  ...
  { slug: "fes", nameAr: "فاس", countryAr: "المغرب", lat: 34.0181, lng: -5.0078, tz: "Africa/Casablanca", method: "mwl", methodLabel: "رابطة العالم الإسلامي", note: "شرق الرباط داخلياً. نفس الطريقة والتوقيت." },
  ...
  { slug: "benghazi", nameAr: "بنغازي", countryAr: "ليبيا", lat: 32.1167, lng: 20.0667, tz: "Africa/Tripoli", method: "mwl", methodLabel: "رابطة العالم الإسلامي", note: "شرق ليبيا. التوقيت Africa/Tripoli كما في IANA. لا نعرض أوقاتاً مقدّرة." },
];
