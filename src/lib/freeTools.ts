...
export const FREE_TOOLS = [
  {
    ...
    title: "صانع الفيديو المتحرك من الوصف",
    desc: "اكتب ماذا يحدث (قطط تلعب، كلب يركض تحت المطر…) واحصل فوراً على فيديو ريلز بشخصيات تتحرك فعلاً وأصوات للمكان — بمحركنا الخاص، مجاناً.",
  },
  {
