...
export const FREE_TOOLS = [
  {
    ...
    title: "صانع الفيديو من الوصف بالذكاء الاصطناعي",
    desc: "اكتب وصفاً قصيراً (مع صورتك أو بدونها) واحصل على فيديو ريلز بمشاهد مرسومة بالذكاء الاصطناعي وموسيقى — جرّبه مجاناً.",
  },
  {
