...
export async function handleNameCompatBotUpdate(bot: TelegramBot, botRow: BotRow, update: any) {
  ...
  if (text === "ℹ️ معلومات") {
    ...
    const info =
      `ℹ️ بوت نسبة التوافق\n\n` +
      `بوت ترفيهي ممتع لحساب نسبة التوافق بين أي اسمين!\n\n` +
      `━━━━━━━━━━━━━━━\n` +
      `💞 كيف يعمل:\n` +
      `• اضغط «💞 احسب نسبة التوافق» ثم أرسل الاسم الأول.\n` +
      `• أرسل الاسم الثاني.\n` +
      `• يظهر لك نسبة التوافق فوراً مع بطاقة نتيجة جميلة.\n\n` +
      `━━━━━━━━━━━━━━━\n` +
      `🔢 النتيجة ثابتة:\n` +
      `• نفس الاسمين يعطيان دائماً نفس النسبة.\n` +
      `• لا فرق في الترتيب — أحمد + سارة = سارة + أحمد.\n` +
      `• النتيجة للتسلية فقط وليست علمية.\n\n` +
      `━━━━━━━━━━━━━━━\n` +
      `📜 آخر نتائجي:\n` +
