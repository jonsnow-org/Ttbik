...
export async function handleJobsBotUpdate(bot: TelegramBot, botRow: BotRow, update: any) {
  ...
  if (text === "ℹ️ معلومات") {
    ...
    const info =
      ...
      `بوابتك الشاملة لسوق العمل والتجارة — وظائف، خدمات مهنية، بيع وشراء، وعروض أسعار تنافسية.\n\n` +
      `━━━━━━━━━━━━━━━\n` +
      `💼 قسم العمل:\n` +
      `• 📢 نشر — انشر وظيفة شاغرة أو أعلن عن مهاراتك المهنية ليجدك أصحاب العمل.\n` +
      `• 🔍 بحث — ابحث عن وظائف بحسب مجالك ومدينتك، أو ابحث عن مهنيين (سبّاك، كهربائي، نجّار…).\n\n` +
      `━━━━━━━━━━━━━━━\n` +
      `🛒 قسم المتجر:\n` +
      `• أعلن عن منتج للبيع مع صورة ووصف وسعر.\n` +
      `• تصفّح المنتجات المعروضة واحجز ما يعجبك.\n` +
      `• 🔒 نظام حجز آمن — عند الحجز يُحتجز المبلغ حتى تستلم المنتج وتؤكد، فيُحوَّل للبائع.\n\n` +
      `━━━━━━━━━━━━━━━\n` +
      `🏷 اطلب وهم يتنافسون:\n` +
      `• اكتب ما تحتاجه مرة واحدة (خدمة أو منتج).\n` +
      `• يصل طلبك لكل المهنيين والتجار المختصين في نفس مجالك.\n` +
      `• كل واحد يرسل عرض سعره بشكل سري — لا أحد يرى أسعار الآخرين.\n` +
      `• تقارن العروض بنفسك وتختار الأنسب.\n` +
      `• عند الاختيار تُتبادل معلومات التواصل بينك وبين الفائز.\n\n` +
      `━━━━━━━━━━━━━━━\n` +
      `👤 الملف الشخصي:\n` +
      `• سجّل اسمك ومدينتك ومهنتك وطريقة التواصل.\n` +
      `• ملفك يظهر في نتائج البحث ويستقبل طلبات الأسعار.\n\n` +
      `━━━━━━━━━━━━━━━\n` +
      `💰 الرصيد:\n` +
      `• اشحن رصيدك واستخدمه للنشر والحجز.\n\n` +
      `💡 لاقتراح خاصية جديدة اضغط «اقتراح».\n` +
