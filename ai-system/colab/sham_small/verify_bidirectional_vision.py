...
trained capability of ShamSmall, not just generation with an external
...
@torch.no_grad()
def _masked_loss(model: ShamSmall, input_ids: torch.Tensor, target_labels: torch.Tensor) -> float:
