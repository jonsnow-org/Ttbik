...
real ShamSmall forward pass, then decodes every modality back out and
...
def main() -> None:
    ...
    print(f"ShamSmall processed the full text+image+audio+video sequence OK: "
    ...
    print("\nAll checks passed — text, image, audio, and video coexist correctly "
          "in one sequence through ShamSmall's single shared brain and vocabulary.")
