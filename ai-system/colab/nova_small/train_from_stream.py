"""
Nova Small — fused stream-to-weights training. Owner's own idea, made
...
class StreamingTokenBatcher:
    ...
    def __init__(self, text_stream: Iterator[str], tokenizer: NovaTextTokenizer, seq_len: int, batch_size: int):
...
if __name__ == "__main__":
    ...
    _CORPUS_SENTENCES = [
        "Nova Small is a real, from-scratch multimodal transformer trained on real streamed data.",
    ...
    model_cfg = NovaSmallConfig(vocab_size=42256, d_model=64, n_layers=4, n_heads=4, n_kv_heads=2, mlp_hidden=128, max_seq_len=32)
