"""
Nova Small — video handling. Per owner spec, 2026-09-14 ("نبني نماذج
...
and audio_tokenizer.py's own jobs:
  - encode_video(): run image_tokenizer.encode() on every frame of a
    ...
    NovaSmall's transformer can tell where each frame starts and ends.
...
offset into NovaSmall's shared vocabulary):
  <VIDEO_START>
