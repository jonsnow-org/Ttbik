"""
Nova Small — the real text tokenizer. Everything else built so far
...
class NovaTextTokenizer:
    ...
    @classmethod
    def load(cls, path: str | Path) -> "NovaTextTokenizer":
...
def train_text_tokenizer(
    ...
    return NovaTextTokenizer(tokenizer)
...
if __name__ == "__main__":
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        reloaded = NovaTextTokenizer.load(save_path)
    ...
    test_strings = [
        "Nova Small is a real, from-scratch transformer.",
