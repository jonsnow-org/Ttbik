"""
Nova Small — real autoregressive generation. Everything built so far
...
if __name__ == "__main__":
    ...
    torch.manual_seed(0)
    cfg = NovaSmallConfig(vocab_size=42256, d_model=64, n_layers=4, n_heads=4, n_kv_heads=2, mlp_hidden=128, max_seq_len=1024)
    model = NovaSmall(cfg)
