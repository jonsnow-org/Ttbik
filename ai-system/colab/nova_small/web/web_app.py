"""
Nova Small — standalone Streamlit web UI, mirroring the exact same
...
BACKEND_URL = os.environ.get("NOVA_SMALL_BACKEND_URL", "http://localhost:8000")

st.set_page_config(page_title="Nova Small (تجريبي)", page_icon="🧪")
st.title("🧪 Nova Small — اختبار مباشر")
st.caption(
